...
// gets the width of the character, as derived from the first font byte, as
// well as the first fontbyte bitmap itself.
//
// char c;
...
// fontByte = (pgm_read_byte(&Font5x5p[(c - 0x20 - idxOffset) * 5]) & 0x1f);
//
